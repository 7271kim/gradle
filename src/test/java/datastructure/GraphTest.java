...
public class GraphTest {
    ...
    private GraphWithMatrix graphWithMatrix;
    ...
    public void setup() {
        ...
        graphWithMatrix = new GraphWithMatrix(5);
        graphWithMatrix.add(stores.get("엽떡"), stores.get("갑떡"), 2);
        graphWithMatrix.addDirection(stores.get("그떡"), stores.get("엽떡"), 7);
        graphWithMatrix.addDirection(stores.get("그떡"), stores.get("호떡"), 3);
        graphWithMatrix.addDirection(stores.get("갑떡"), stores.get("그떡"), 9);
        graphWithMatrix.add(stores.get("갑떡"), stores.get("십떡"), 4);
    ...
    public void createGrapWithMatrixTest() {
        assertThat(graphWithMatrix.isConected(stores.get("엽떡"), stores.get("갑떡"))).isEqualTo(true);
        assertThat(graphWithMatrix.isConected(stores.get("엽떡"), stores.get("그떡"))).isEqualTo(false);
        assertThat(graphWithMatrix.isConected(stores.get("그떡"), stores.get("갑떡"))).isEqualTo(false);
        assertThat(graphWithMatrix.isConected(stores.get("갑떡"), stores.get("그떡"))).isEqualTo(true);
        assertThat(graphWithMatrix.isConected(stores.get("그떡"), stores.get("호떡"))).isEqualTo(true);
    }

    @Test
    @DisplayName("인접행렬 dfs Test")
    public void dfsGrapWithMatrixTest() {
        assertThat(graphWithMatrix.dfs(stores.get("엽떡"))).isEqualTo(new ArrayList<>(Arrays.asList(1, 3, 2, 5, 4)));
        assertThat(graphWithMatrix.dfs(stores.get("그떡"))).isEqualTo(new ArrayList<>(Arrays.asList(2, 1, 3, 4, 5)));
    }

    @Test
    @DisplayName("인접행렬 bfs Test")
    public void bfsGrapWithMatrixTest() {
        assertThat(graphWithMatrix.bfs(stores.get("엽떡"))).isEqualTo(new ArrayList<>(Arrays.asList(1, 3, 2, 4, 5)));
        assertThat(graphWithMatrix.bfs(stores.get("호떡"))).isEqualTo(new ArrayList<>(Arrays.asList(5)));
        assertThat(graphWithMatrix.bfs(stores.get("그떡"))).isEqualTo(new ArrayList<>(Arrays.asList(2, 1, 5, 3, 4)));
    }
}
